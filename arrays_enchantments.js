...
function setItem(cards, position, replacementCard) {
    if(validPosition(cards, position)){
...
function validPosition(cards, position){
    if(position < cards.length) return true
    else throw new Error("Index out of array range!")
}